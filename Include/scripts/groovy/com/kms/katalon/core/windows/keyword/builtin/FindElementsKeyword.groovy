...
@Action(value = "findElements")
public class FindElementsKeyword extends AbstractKeyword {
    ...
    public List<WebElement> findElement(WindowsTestObject testObject, FailureHandling flowControl)
        throws StepFailedException {
        return (List<WebElement>) KeywordMain.runKeyword({
            ...
            logger.logPassed(String.format('Search for elements with locator: [%s="%s"]', locatorStrategy, locator))
            
            return WindowsActionHelper.create(WindowsDriverFactory.getWindowsSession()).findElements(testObject)
        }, flowControl)
    }
}
