...
@Action(value = "rightClickElementOffset")
public class RightClickElementOffsetKeyword extends AbstractKeyword {

    private KeywordLogger logger = KeywordLogger.getInstance(RightClickElementOffsetKeyword.class)
    ...
    public Object execute(Object ...params) {
        ...
        rightClickOffset(testObject, offsetX, offsetY, flowControl);
    }

    public void rightClickOffset(WindowsTestObject testObject, int offsetX, int offsetY, FailureHandling flowControl) throws StepFailedException {
        KeywordMain.runKeyword({
            ...
            WindowsActionHelper.create(WindowsDriverFactory.getWindowsSession()).rightClickOffset(testObject, offsetX, offsetY);
