...
@Action(value = "switchToApplication")
public class SwitchToApplicationKeyword extends AbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        switchToApplication(flowControl)
    }

    public void switchToApplication(FailureHandling flowControl) throws StepFailedException {
        KeywordMain.runKeyword({
            WindowsActionHelper.create(WindowsDriverFactory.getWindowsSession()).switchToApplication()
        }, flowControl)
    }
}