...
public class AppiumRequestService {
    ...
    private String sendGetRequest(String url) throws UnsupportedOperationException, IOException, URISyntaxException, GeneralSecurityException {
        ProxyInformation proxyInfo = RunConfiguration.getProxyInformation();
        try (CloseableHttpClient client = HttpClientProxyBuilder.create(proxyInfo).getClientBuilder().build();
