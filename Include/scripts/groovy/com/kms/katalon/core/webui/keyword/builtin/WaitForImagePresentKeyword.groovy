...
@Action(value = "waitForImagePresent")
public class WaitForImagePresentKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        int timeOutInSeconds = (int) params[1]
        FailureHandling flowControl = (FailureHandling)(params.length > 2 && params[2] instanceof FailureHandling ? params[2] : RunConfiguration.getDefaultFailureHandling())
        return waitForImagePresent(to, timeOutInSeconds, flowControl)
    }

    @CompileStatic
    public boolean waitForImagePresent(TestObject to, int timeOutInSeconds, FailureHandling flowControl) throws StepFailedException {
