...
@Action(value = "deleteAllCookies")
public class DeleteAllCookiesKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        deleteAllCookies(flowControl)
    }

    @CompileStatic
    public void deleteAllCookies(FailureHandling flowControl) throws StepFailedException {
