...
@Action(value = "clickImage")
public class ClickImageKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        clickImage(to,flowControl)
    }

    @CompileStatic
    public void clickImage(TestObject to, FailureHandling flowControl) {
