...
@Action(value = "verifyElementHasAttribute")
public class VerifyElementHasAttributeKeyword extends WebUIAbstractKeyword {
    ...
    public Object execute(Object ...params) {
        ...
        return verifyElementHasAttribute(to,attributeName,timeOut,flowControl)
    }
    ...
    public boolean verifyElementHasAttribute(TestObject to, String attributeName, int timeOut, FailureHandling flowControl) {
        WebUIKeywordMain.runKeyword({
            ...
            return false
        }, flowControl, true, (to != null) ? MessageFormat.format(StringConstants.KW_MSG_CANNOT_VERIFY_OBJ_X_HAS_ATTRIBUTE_Y, [to.getObjectId(), attributeName] as Object[])
